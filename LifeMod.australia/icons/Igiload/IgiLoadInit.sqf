...
cutText ["Elite-IgiLoad is loading. Please wait...","PLAIN",2];
sleep (random 30);

cutText [Format ["Elite-IgiLoad init Player: %1", Player],"PLAIN",2];
...
cutText ["Elite-IgiLoad loaded. Have fun :)","PLAIN",2];
