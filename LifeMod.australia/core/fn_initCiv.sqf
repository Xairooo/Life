...
private _australiaArray = ["Land_largescrapper","Land_Hotel","Land_aus_hotel","Land_greyhirise"];
private _spawnBuildings = [[["Altis", _altisArray], ["australia", _australiaArray]]] call TON_fnc_terrainSort;
