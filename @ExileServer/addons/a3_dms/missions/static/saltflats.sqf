...
[
	[
		...
		[
			880,		// At least a 5 minute delay between reinforcements.
			diag_tickTime
		],
		[
			[23239.7,18865.8,0],
		...
		"armed_vehicle",
		[
			1,			// Reinforcements will only trigger if there's fewer than 7 members left in the group
	...
	[
		...
		[
			880,		// About a 4 minute delay between reinforcements.
			diag_tickTime
		],
		_AISoldierSpawnLocations,
		"random",
		...
		"reinforce",
		[
			1,			// Reinforcements will only trigger if there's fewer than 10 members left in the group
