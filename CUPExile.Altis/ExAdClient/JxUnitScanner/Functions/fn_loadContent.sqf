...
_log = "loadContent>>";
_log = _log + str([_display, ["Car","Air","Tank"], 120, "picC"] call ExAd_fnc_showUnits);
_log = _log + str([_display, ["Man"], 120, "picM"] call ExAd_fnc_showUnits);
_log = _log + str([_display, ["O_HMG_01_high_F","O_GMG_01_high_F"], 120, "picH"] call ExAd_fnc_showUnits); //works
