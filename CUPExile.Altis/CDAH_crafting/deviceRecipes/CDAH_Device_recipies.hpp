...
class Craftbox: Exile_AbstractCraftingRecipe
{
	name = "Craftbox";
	...
	category = "Vehicle Craft Devices";
};		
	
class Terminal: Exile_AbstractCraftingRecipe  
{
    name = "Terminal";
...
class Tooltrolley: Exile_AbstractCraftingRecipe  
{
    name = "Tooltrolley";
...
class Crane: Exile_AbstractCraftingRecipe  
{
    name = "Crane";
...
class Transformer: Exile_AbstractCraftingRecipe
{
	name = "Transformer";
...
class SlingloadRepair: Exile_AbstractCraftingRecipe
{
...
class SlingloadFuel: Exile_AbstractCraftingRecipe
{
	name = "Fuelcontainer";
...
/* class Helispot: Exile_AbstractCraftingRecipe
{
	name = "Spot";
	pictureItem = "CDAH_Helipad_Kit";
	returnedItems[] = 
...
class EngineStarter: Exile_AbstractCraftingRecipe
{
	name = "Engine Starter";
...
class SlingloadAmmo: Exile_AbstractCraftingRecipe
{
	name = "Ammocontainer";
