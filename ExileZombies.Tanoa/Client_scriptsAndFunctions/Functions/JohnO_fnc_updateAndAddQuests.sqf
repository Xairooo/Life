...
switch (ExileReborn_quest_progress) do
{
	case -1:
	{
		...
		["InfoTitleAndText", ["ExileZombies.com - Tutorial One", "You have a new task check your map 'Tasks' for more info"]] call ExileClient_gui_toaster_addTemplateToast;
	...
	case 1:
	{
		...
		[
		   "
		   ExileZombies.com features many custom user actions these include but are not limited to<br/>
		...
		["InfoTitleAndText", ["ExileZombies.com - Tutorial Two - User actions", "You have a new task check your map 'Tasks' for more info"]] call ExileClient_gui_toaster_addTemplateToast;
			...
			if ((ExileReborn_client_completedScavengeTask) && (ExileReborn_client_completedBerryTask)) then
			{
				...
				["InfoTitleAndText",
					[
			            ...
			            format ["You now have a better understanding of ExileZombies.com custom user actions, be sure to see what other benefits you can gain from these actions - %1 respect earned", _addRespect]
				    ]
			    ] call ExileClient_gui_toaster_addTemplateToast;
	...
	case 2:
	{
		...
		[
		   "
		   ExileZombies.com features different types of AI<br/>
		...
		["InfoTitleAndText", ["ExileZombies.com - Tutorial Three - Survivors and Bandits", "You have a new task check your map 'Tasks' for more info"]] call ExileClient_gui_toaster_addTemplateToast;
		...
		Check_survivorsAndBandits_completed =
		{
			if (ExileReborn_succesfullyBribed) then
			{
				...
				["InfoTitleAndText",
					[
			            "Survivors and Bandits",
			            format ["You should now have a better understanding of the AI entities in ExileZombies.com, respect them and survive - %1 respect", _addRespect]
				    ]
			    ] call ExileClient_gui_toaster_addTemplateToast;
	...
	case 3:
	{
		["InfoTitleAndText", ["ExileZombies.com - Tutorial Four", "Coming soon..."]] call ExileClient_gui_toaster_addTemplateToast;
	};
};